...
@section('content')
    ...
    <div class="max-w-2xl mx-auto bg-gray-800 p-6 rounded shadow text-white">
        ...
        <form action="{{ route('events.update',$event->id) }}" @submit="loading = true;" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <!-- Profile Picture -->
            <div class="mt-4">
            ...
            <div class="mt-4">
                ...
                <input type="datetime-local" name="event_date" id="" value="{{ $event->event_date }}"
